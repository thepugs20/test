...
$(document).ready(function() {
	...
	$('#documenter_sidebar ul a').click( function (e) {
		e.preventDefault();
		$('html, body').animate({
	...
	$(document).on('click', '._TAB_', function (e) {
		$('._TAB_').removeClass('_ACTIVE_');
		$(this).addClass('_ACTIVE_');
		$('.TAB_DATA').removeClass('_ACTIVE_');
		$(document).find('#'+$(this).attr('data-id')+'').addClass('_ACTIVE_');
	})
